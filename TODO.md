...
- [ ] **No SDDL validation**: Add a validating `AppContainerSid::try_from_sddl()` that checks format
- [ ] **ACL inheritance inflexible**: Make directory inheritance flags configurable
...
- [ ] **Magic number constants**: Replace `ACE_FLAGS(0x3u32)` and `0x0000_0004` with named constants
